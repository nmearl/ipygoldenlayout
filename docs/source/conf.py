...
# -*- coding: utf-8 -*-
#
# ipygoldenlayout documentation build configuration file
#
...
project = 'ipygoldenlayout'
copyright = '2019, Nicholas Earl'
...
_version_py = os.path.join(repo, 'ipygoldenlayout', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipygoldenlayoutdoc'
...
latex_documents = [
    (master_doc, 'ipygoldenlayout.tex', 'ipygoldenlayout Documentation',
